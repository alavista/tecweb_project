...
function getProducts($conn, $category, $vegan, $celiac, $sorting) {
    ...
    if (!($stmt = $conn->prepare("SELECT p.nome as pnome, p.costo, p.vegano as vegano, p.celiaco as celiaco, c.nome as cnome, f.IDFornitore as IDFornitore, f.nome as fnome, AVG(r.valutazione) as valutazione_media, COUNT(r.IDRecensione) as nrec
