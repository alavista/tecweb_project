$(function() {
    ...
    $(document).on("click", ".changeProduct", function() {
        ...
        $("#newProductCeliac_" + idProduct).prop('checked', $("#productCeliac_" + idProduct).html().indexOf("celiaco") != -1 ? true : false);
            ...
            if ($.isNumeric(productCost) && productCost > 0) {
                $.post("../php/changeProduct.php", {
                    ...
                    if (data.status.localeCompare("ERROR") == 0) {
                        ...
                        $("#productCeliac_" + idProduct).html(celiac ? "<span class='font-italic'> (celiaco)</span>" : "");
